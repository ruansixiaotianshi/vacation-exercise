<template>
    ...
    <el-form  :model="loginForm" :rules="rules" class="login-container" label-position="left"
        ...
        <el-form-item >
            <el-checkbox-group v-model="form.type" prop="check">
<!--                <el-checkbox label="政府" name="type"    value="gov" ></el-checkbox>-->
<!--                <el-checkbox label="浪潮管理" name="type" value="company"></el-checkbox>-->
<!--                <el-checkbox label="普通用户" name="type" value="user"></el-checkbox>-->
                <el-checkbox label="gov" name="type"    value="gov" >政府</el-checkbox>
                <el-checkbox label="company" name="type" value="company">浪潮管理</el-checkbox>
                <el-checkbox label="user" name="type" value="">普通用户</el-checkbox>
<!--                <el-checkbox  name="type"  :label="gov">政府</el-checkbox>-->

<!--                <el-checkbox  name="type"  :label="company">浪潮管理</el-checkbox>-->
<!--                <el-checkbox  name="type"  :label="user">普通用户</el-checkbox>-->

<!--                <el-checkbox  name="type" true-label="gov" >政府</el-checkbox>-->
<!--                <el-checkbox  name="type" true-label="company">浪潮管理</el-checkbox>-->
<!--                <el-checkbox  name="type" true-label="user">普通用户</el-checkbox>-->
    ...
    export default {
        ...
        methods: {
            ...
            register(){
                ...
                this.loginForm.role = this.form.type[0];
                // this.loginForm.role = document.getElementsByName("type")[checked];
                this.$axios
                    .post('http://localhost:8181/users', {
                        username: this.loginForm.username,
                        password: this.loginForm.password,
                        role:this.form.type[0]
                    })
